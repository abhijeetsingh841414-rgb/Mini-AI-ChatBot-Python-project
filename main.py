...
name = input("Welcome, Enter your name please : ")
...
responses = {
    ...
    "our states" : "I am build the ShopEase e-commarse store project by using the HTML, CSS, JavaScript",
